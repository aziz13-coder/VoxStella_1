...
def test_goal_model_regeneration_preserves_calibrated_travel_ceilings():
    ...
    assert regenerated["travel_fun"]["normalization"]["max_score"] == 34
    assert regenerated["travel_relax"]["normalization"]["max_score"] == 34
