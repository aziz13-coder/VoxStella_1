...
# CRITICAL FIX: Property questions use Lilly's 1st/4th/7th/10th framework.
# L2 may remain a secondary money witness, but not a co-primary significator.
CATEGORY_RULES[Category.PROPERTY] = {
    "primary_significators": ["L1", "L4"],  # Querent and property itself
    "secondary_significators": ["L7", "L10", "L2"],  # Seller/landlord, price/profit, money
    "allowed_turned_houses": {},
    "outcome_houses": [4, 7, 10],  # Property/end, seller/landlord, price/profit
    "irrelevant_houses": [2, 3, 5, 6, 8, 9, 11, 12],
    "scored_factors": ["debilitation", "cadent_significator", "significator_strength", "house_condition"],
    "testimony_hierarchy": {
...
CATEGORY_RULES[Category.LAWSUIT] = {
    "primary_significators": ["L1", "L7"],
    "secondary_significators": ["L10", "L4", "L2", "L8"],
    "allowed_turned_houses": {},
    "outcome_houses": [4, 10],
    "scored_factors": ["debilitation", "cadent_significator", "significator_strength", "house_condition"],
    "testimony_hierarchy": {
