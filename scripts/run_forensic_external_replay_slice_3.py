...
FIXTURE_PATH = REPO_ROOT / "tests" / "fixtures" / "forensic_external_replay_slice_3.json"
RESULTS_PATH = REPO_ROOT / "tests" / "fixtures" / "forensic_external_replay_slice_3_results.json"
...
def main():
    ...
    results = []
    for case in load_forensic_replay_cases(FIXTURE_PATH):
