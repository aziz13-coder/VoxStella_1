...
INPUT_PATH = REPO_ROOT / "tests" / "fixtures" / "synastry_historical_replay_slice_2.json"
OUTPUT_PATH = REPO_ROOT / "tests" / "fixtures" / "synastry_historical_replay_slice_2_results.json"


def main():
    fixture = load_synastry_historical_replay_cases(path=INPUT_PATH)
    results = []
    ...
    payload = {
        ...
        "purpose": "Replay results for the second replay-ready synastry historical validation slice.",
