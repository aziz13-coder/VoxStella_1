...
INPUT_PATH = REPO_ROOT / "tests" / "fixtures" / "synastry_historical_replay_slice_3.json"
OUTPUT_PATH = REPO_ROOT / "tests" / "fixtures" / "synastry_historical_replay_slice_3_results.json"
...
def main():
    ...
    payload = {
        ...
        "purpose": "Replay results for the third replay-ready synastry historical validation slice.",
