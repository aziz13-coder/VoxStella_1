...
REPLAY_FIXTURE_PATH = Path(__file__).resolve().parents[1] / "tests" / "fixtures" / "forensic_case_replay_slice_4.json"


class ForensicReplaySliceFourTests(unittest.TestCase):
    ...
    def test_metadata_basis_is_tracked(self):
        ...
        self.assertEqual(cases["sam_sheppard"]["metadata_basis"], "source_explicit_prose")
        self.assertEqual(cases["sam_sheppard"]["metadata_confidence"], "high")
        self.assertEqual(cases["diane_downs"]["metadata_confidence"], "medium")
        self.assertEqual(cases["marilyn_monroe_murder"]["metadata_basis"], "source_explicit_prose_plus_case_context")
