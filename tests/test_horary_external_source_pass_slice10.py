...
FIXTURE_PATH = (
    ...
    / "fixtures"
    / "horary_external_source_pass_slice10.json"
)
...
def test_slice10_contains_three_refund_repayment_cases():
    cases = _load_cases()
    assert len(cases) == 3


def test_slice10_tracks_all_cases_as_aligned_after_repayment_doctrine_pass():
    cases = _load_cases()
...
def test_slice10_engine_observations_match_current_analyzer_behavior():
