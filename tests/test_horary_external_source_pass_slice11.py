...
FIXTURE_PATH = (
    ...
    / "fixtures"
    / "horary_external_source_pass_slice11.json"
)
...
def test_slice11_contains_three_property_transition_cases():
    cases = _load_cases()
    assert len(cases) == 3


def test_slice11_tracks_all_property_transition_cases_as_aligned_after_doctrine_pass():
    cases = _load_cases()
...
def test_slice11_engine_observations_match_current_analyzer_behavior():
