...
FIXTURE_PATH = (
    ...
    / "fixtures"
    / "horary_external_source_pass_slice12.json"
)
...
def test_slice12_contains_three_loan_and_borrowing_cases():
    cases = _load_cases()
    assert len(cases) == 3


def test_slice12_tracks_all_cases_as_aligned_after_loan_lender_doctrine_pass():
    cases = _load_cases()
...
def test_slice12_engine_observations_match_current_analyzer_behavior():
