...
FIXTURE_PATH = (
    ...
    / "fixtures"
    / "horary_external_source_pass_slice13.json"
)
...
def test_slice13_contains_three_visa_and_immigration_cases():
    cases = _load_cases()
    assert len(cases) == 3


def test_slice13_tracks_all_cases_as_aligned_after_visa_doctrine_pass():
    cases = _load_cases()
...
def test_slice13_engine_observations_match_current_analyzer_behavior():
