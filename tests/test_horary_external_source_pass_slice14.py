...
FIXTURE_PATH = (
    ...
    / "fixtures"
    / "horary_external_source_pass_slice14.json"
)
...
def test_slice14_contains_three_custody_and_family_court_cases():
    cases = _load_cases()
    assert len(cases) == 3


def test_slice14_tracks_all_cases_as_aligned_after_custody_doctrine_pass():
    cases = _load_cases()
...
def test_slice14_engine_observations_match_current_analyzer_behavior():
