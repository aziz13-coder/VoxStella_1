...
FIXTURE_PATH = (
    ...
    / "fixtures"
    / "horary_external_source_pass_slice16.json"
)
...
def test_slice16_contains_three_publishing_and_publication_cases():
    cases = _load_cases()
    assert len(cases) == 3


def test_slice16_tracks_all_cases_as_aligned_after_publication_doctrine_pass():
    cases = _load_cases()
...
def test_slice16_engine_observations_match_current_analyzer_behavior():
