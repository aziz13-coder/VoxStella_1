...
FIXTURE_PATH = (
    ...
    / "fixtures"
    / "horary_external_source_pass_slice18.json"
)
...
def test_slice18_contains_three_inheritance_and_estate_cases():
    cases = _load_cases()
    assert len(cases) == 3


def test_slice18_tracks_all_cases_as_aligned_after_inheritance_doctrine_pass():
    cases = _load_cases()
...
def test_slice18_engine_observations_match_current_analyzer_behavior():
