...
FIXTURE_PATH = (
    ...
    / "fixtures"
    / "horary_external_source_pass_slice19.json"
)
...
def test_slice19_contains_three_grant_scholarship_and_aid_cases():
    cases = _load_cases()
    assert len(cases) == 3


def test_slice19_tracks_all_cases_as_aligned_after_shared_aid_doctrine_pass():
    cases = _load_cases()
...
def test_slice19_engine_observations_match_current_analyzer_behavior():
