...
FIXTURE_PATH = (
    ...
    / "fixtures"
    / "horary_external_source_pass_slice20.json"
)
...
def test_slice20_contains_three_vehicle_acquisition_and_sale_cases():
    cases = _load_cases()
    assert len(cases) == 3


def test_slice20_tracks_all_cases_as_aligned_after_vehicle_doctrine_pass():
    cases = _load_cases()
...
def test_slice20_engine_observations_match_current_analyzer_behavior():
