...
FIXTURE_PATH = (
    ...
    / "fixtures"
    / "horary_external_source_pass_slice21.json"
)
...
def test_slice21_contains_three_citizenship_and_residency_cases():
    cases = _load_cases()
    assert len(cases) == 3


def test_slice21_is_fully_aligned_after_citizenship_status_doctrine_pass():
    cases = _load_cases()
...
def test_slice21_engine_observations_match_current_analyzer_behavior():
