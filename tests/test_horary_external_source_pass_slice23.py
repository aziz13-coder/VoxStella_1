...
FIXTURE_PATH = (
    ...
    / "fixtures"
    / "horary_external_source_pass_slice23.json"
)
...
def test_slice23_contains_three_passport_document_cases():
    cases = _load_cases()
    assert len(cases) == 3


def test_slice23_is_fully_aligned_after_passport_doctrine_pass():
    cases = _load_cases()
...
def test_slice23_engine_observations_match_current_analyzer_behavior():
