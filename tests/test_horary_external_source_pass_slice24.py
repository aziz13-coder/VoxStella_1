...
FIXTURE_PATH = (
    ...
    / "fixtures"
    / "horary_external_source_pass_slice24.json"
)
...
def test_slice24_contains_three_roommate_and_cohabitation_cases():
    cases = _load_cases()
    assert len(cases) == 3


def test_slice24_is_fully_aligned_after_roommate_and_cohabitation_pass():
    cases = _load_cases()
...
def test_slice24_engine_observations_match_current_analyzer_behavior():
