...
FIXTURE_PATH = (
    ...
    / "fixtures"
    / "horary_external_source_pass_slice7.json"
)
...
def test_slice7_contains_three_legal_adjudication_cases():
    cases = _load_cases()
    assert len(cases) == 3


def test_slice7_tracks_all_cases_as_aligned_after_lawsuit_doctrine_pass():
    cases = _load_cases()
...
def test_slice7_engine_observations_match_current_analyzer_behavior():
