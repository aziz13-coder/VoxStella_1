...
FIXTURE_PATH = (
    ...
    / "fixtures"
    / "horary_external_source_pass_slice8.json"
)
...
def test_slice8_contains_three_turned_relative_cases():
    cases = _load_cases()
    assert len(cases) == 3


def test_slice8_tracks_all_cases_as_aligned_after_relative_doctrine_pass():
    cases = _load_cases()
...
def test_slice8_engine_observations_match_current_analyzer_behavior():
