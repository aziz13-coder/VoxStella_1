...
FIXTURE_PATH = (
    ...
    / "fixtures"
    / "horary_external_source_pass_slice9.json"
)
...
def test_slice9_contains_three_theft_cases():
    cases = _load_cases()
    assert len(cases) == 3


def test_slice9_tracks_all_cases_as_aligned_after_theft_doctrine_pass():
    cases = _load_cases()
...
def test_slice9_engine_observations_match_current_analyzer_behavior():
